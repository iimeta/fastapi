...
// 应用消费额度
func (s *sApp) SpendQuota(ctx context.Context, appId, quota, currentQuota int) error {
...
// 密钥消费额度
func (s *sApp) AppKeySpendQuota(ctx context.Context, secretKey string, quota, currentQuota int) error {
