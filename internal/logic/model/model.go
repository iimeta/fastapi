...
func (s *sModel) UpdateCacheModel(ctx context.Context, oldData *entity.Model, newData *entity.Model) {
	...
	model := &model.Model{
		...
		IsEnableDataPassthrough:  newData.IsEnableDataPassthrough,
		ReqPassthroughParams:     newData.ReqPassthroughParams,
		ReqHeaderPassthroughMode: newData.ReqHeaderPassthroughMode,
		ReqHeaderPassthroughList: newData.ReqHeaderPassthroughList,
		ResPassthroughParams:     newData.ResPassthroughParams,
