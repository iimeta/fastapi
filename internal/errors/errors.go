...
var (
	...
	ERR_INVALID_RESELLER              = NewError(401, "invalid_reseller", "Reseller does not exist or has been disabled.", "fastapi_request_error")
	ERR_RESELLER_DISABLED             = NewError(401, "reseller_disabled", "Reseller has been disabled.", "fastapi_request_error")
	...
	ERR_GROUP_DISABLED                = NewError(401, "group_disabled", "Group has been disabled.", "fastapi_request_error")
	ERR_GROUP_EXPIRED                 = NewError(401, "group_expired", "Group has expired.", "fastapi_request_error")
	...
	ERR_GROUP_NOT_FOUND               = NewError(404, "group_not_found", "The group does not exist or you do not have access to it.", "fastapi_request_error")
	ERR_RESELLER_INSUFFICIENT_QUOTA   = NewError(429, "reseller_insufficient_quota", "You reseller exceeded current quota.", "fastapi_request_error")
	ERR_RESELLER_QUOTA_EXPIRED        = NewError(429, "reseller_quota_expired", "You reseller quota has expired.", "fastapi_request_error")
