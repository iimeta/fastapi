...
var (
	...
	ERR_MODEL_UNSUPPORTED_BILLING_METHOD = NewError(400, "model_unsupported_billing_method", "Billing methods not supported by the current model.", "fastapi_request_error", nil)
	ERR_GROUP_UNSUPPORTED_BILLING_METHOD = NewError(400, "group_unsupported_billing_method", "Billing methods not supported by the current group.", "fastapi_request_error", nil)
